...
function Env(t, e){
    ...
    return new class{
        ...
        initGotEnv(t){this.got = this.got ? this.got : require("../ninja/backend/node_modules/got"), this.cktough = this.cktough ? this.cktough : require("tough-cookie"), this.ckjar = this.ckjar ? this.ckjar : new this.cktough.CookieJar, t && (t.headers = t.headers ? t.headers : {}, void 0 === t.headers.Cookie && void 0 === t.cookieJar && (t.cookieJar = this.ckjar))}
